  ...
  return (
    <div className="flex flex-col items-center">
      ...
      >
        ...
        <h3 className="text-2xl sm:text-3xl font-bold text-center text-pink-600 mt-2">Subhaa 💖</h3>
      </motion.div>
          ...
          <AnimatePresence>
            ...
            >
              <div className="text-center">
                ...
                Just wanted to remind you - you’re one of those people who make life feel a little nicer and you have this quiet way of making everything feel better. 
                </p>
                <p className="text-pink-600 font-medium">I hope your birthday is filled with all the little things that make you smile and feel at peace ✨💖</p>
                <div className="flex justify-center">
                  <motion.div
                    animate={{
                      scale: [1, 1.2, 1],
      ...
      >
        <div className="text-center">
          ...
          May every wish you make today come true. You deserve the world, and maybe I’ll always be here to remind you of that.
          </p>
          <div className="flex justify-center items-center gap-2">
            <p className="text-pink-600 font-medium">If birthdays were measured by smiles, yours would last a lifetime 🫶</p>
          </div>
        </div>
      </motion.div>
    </div>
